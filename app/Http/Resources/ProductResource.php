...
class ProductResource extends ProductIndexResource
{
    ...
    public function toArray($request)
    {
        return array_merge(parent::toArray($request), [
            ...
            'stitched_price_pkr' => $this->stitched_price_pkr,
            'stitched_price_usd' => $this->stitched_price_usd,
            'stitched_price_eur' => $this->stitched_price_eur,
            'stitched_price_aud' => $this->stitched_price_aud,
            'stitched_price_gbp' => $this->stitched_price_gbp,
