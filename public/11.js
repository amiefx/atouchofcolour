...
/* harmony default export */ __webpack_exports__["default"] = (_layout$metaInfo$data = {
  layout: 'print',
  metaInfo: {
...
}, _defineProperty(_layout$metaInfo$data, "filters", {
  formatDate: function formatDate(value) {
    return moment(value).format('MMMM D, YYYY');
  }
}), _defineProperty(_layout$metaInfo$data, "computed", {
  subtotal: function subtotal() {
    return parseFloat(this.order.total) + parseFloat(this.order.discount);
  }
}), _layout$metaInfo$data);
