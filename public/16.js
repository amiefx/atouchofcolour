  ...
  methods: {
    initialize: function initialize() {
      ...
      axios.get("/api/admin/attribute-sets").then(function (res) {
        console.log(res);
        _this.attribute_sets = res.data.data;
      })["catch"](function (err) {
        console.log(err);
      });
    },
    ...
    save: function save() {
      ...
      if (this.editedIndex > -1) {
        axios.put("/api/admin/attributes/" + this.editedItem.id, this.editedItem); //   .then(res => Object.assign(this.roles[this.editedIndex], res.data.data.attribute_set))
        ...
        axios.post("/api/admin/attributes", this.editedItem).then(function (res) {
          return _this4.attributes.push(res.data.attribute);
        })["catch"](function (err) {
