  ...
  methods: {
    ...
    uploadImage1: function uploadImage1(e) {
      ...
      if (file['size'] < 1000000) {
        reader.onloadend = function (file) {
          ...
          _this3.editedItem.image1 = reader.result;
        };
    ...
    uploadImage2: function uploadImage2(e) {
      ...
      if (file['size'] < 1000000) {
        reader.onloadend = function (file) {
          //  console.log('RESULT', reader.result)
          _this4.editedItem.image2 = reader.result;
        };
    ...
    uploadImage3: function uploadImage3(e) {
      ...
      if (file['size'] < 1000000) {
        reader.onloadend = function (file) {
          //  console.log('RESULT', reader.result)
          _this5.editedItem.image3 = reader.result;
        };
    ...
    uploadImage4: function uploadImage4(e) {
      ...
      if (file['size'] < 1000000) {
        reader.onloadend = function (file) {
          //  console.log('RESULT', reader.result)
          _this6.editedItem.image4 = reader.result;
        };
    ...
    uploadPhoto: function uploadPhoto(item) {
      ...
      if (this.editedItem.photo != null) {
        ...
        axios.post("/api/admin/change-photo", formData).then(function (res) {
          _this7.products.data[index].photo = res.data.data.user.photo;
          _this7.editedItem.photo = null;
        })["catch"](function (err) {
    ...
    updateRole: function updateRole(item) {
      ...
      axios.post("/api/admin/change-role", {
        ...
        _this8.text = res.data.data.user.name + "'s Role Updated to " + res.data.data.user.role;
        _this8.snackbar = true;
      })["catch"](function (error) {
        _this8.text = error.response.data.user.name + "'s Role Cannot be Updated" + error.response.data.user.role;
        _this8.products.data[index].role = error.response.data.user.role;
        _this8.snackbar = true;
        console.dir(error.response);
      });
    },
    checkEmail: function checkEmail() {
      ...
      if (/.+@.+\..+/.test(this.editedItem.email)) {
        axios.post("/api/admin/email/verify", {
          ...
          _this9.success = res.data.data.message;
          _this9.error = "";
        })["catch"](function (err) {
          _this9.success = "", _this9.error = "Email Already Exists";
        });
      }
    },
    ...
    deleteAll: function deleteAll() {
      ...
      if (decide) {
        axios.post("/api/admin/products/delete", {
          ...
          _this10.text = "Rcords Deleted Successfully!";

          _this10.selected.map(function (val) {
            var index = _this10.products.data.indexOf(val);

            _this10.products.data.splice(index, 1);
          });
    ...
    searchIt: function searchIt(e) {
      ...
      if (e.length > 3) {
        axios.get("/api/admin/products/".concat(e)).then(function (res) {
          return _this11.products = res.data.data.users;
        })["catch"](function (err) {
      ...
      if (e.length <= 0) {
        ...
        axios.get("/api/admin/products?page=".concat(e.page), {
          ...
          _this11.products = res.data.data.products;
        })["catch"](function (err) {
          return console.dir(err.response);
        });
      }
    ...
    paginate: function paginate(e) {
      ...
      axios.get("/api/admin/products?page=".concat(e.page), {
        ...
        _this12.products = res.data.products;
        console.log(res);
      })["catch"](function (err) {
    ...
    deleteItem: function deleteItem(item) {
      ...
      if (decide) {
        axios["delete"]("/api/admin/products/" + item.id).then(function (res) {
          ...
          _this14.products.data.splice(index, 1);
        })["catch"](function (err) {
          console.log(err.response);
          _this14.text = "Error Deleting Record";
          _this14.snackbar = true;
        });
      }
    },
    close: function close() {
      ...
      this.dialog = false;
      setTimeout(function () {
        _this15.editedItem = Object.assign({}, _this15.defaultItem);
        _this15.editedIndex = -1;
      }, 300);
    },
    save: function save() {
      var _this16 = this;
      ...
      if (this.editedIndex > -1) {
        ...
        .then(function (res) {
          _this16.text = "Record Updated Successfully!";
          _this16.snackbar = true;
          Object.assign(_this16.products.data[index], res.data.data.product);
        })["catch"](function (err) {
          console.log(err.response);
          _this16.text = "Error Updating Record";
          _this16.snackbar = true;
        ...
        axios.post("/api/admin/products", this.editedItem).then(function (res) {
          _this16.$router.replace("/api/admin/products/".concat(res.data.product.slug), {
            params: {
          ...
          console.dir(err);
          _this16.text = "Error Inserting Record";
          _this16.snackbar = true;
        });
      }
