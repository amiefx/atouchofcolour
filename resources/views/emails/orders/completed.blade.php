...
<body>
    Hey {{$order->billing_first_name. ' '.$order->billing_last_name }}, <br>
    Your order #{{$order->id}} has been shipped on {{ date('M-d-Y H:i:s')}} via {{$order->shipping_method}}. You will be updated with another email after your item(s) has been shipped.
    {{-- <v-app>
        <v-container>
