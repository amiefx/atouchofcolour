...
<body>
    ...
    Your order #{{$order->id}} has been placed on {{ date('M-d-Y H:i:s')}} via {{$order->payment_method}}. You will be updated with another email after your item(s) has been shipped.
    {{-- <v-app>
        <v-container>
